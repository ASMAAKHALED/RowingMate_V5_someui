...
//what ever we want to send we can make a child  for it
              /*   new Thread() {
                ...
                */
            //    submitPost();  /// remove rx from player mode
        ...
        if (running) {
            if (mySensor.getType() == Sensor.TYPE_ACCELEROMETER) {
                ...
                if (mySensor.getType() == Sensor.TYPE_ACCELEROMETER) {
                   ...
                   RowerData.angle=angle;
                    TextView kh3 = (TextView) findViewById(R.id.angle);
                    kh3.setText((" angle  "+angle));
//*******tilt by acc
